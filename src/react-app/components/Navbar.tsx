      ...
      <div className="sidebar-bottom">
        <div className="theme-toggle">
          <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
            <path 
              d="M19.5016 11.4109C19.2971 11.2687 19.0371 11.2444 18.8127 11.3444C18.1749 11.6331 17.4894 11.7775 16.7349 11.7775C13.5016 11.7775 10.8683 9.14421 10.8683 5.91087C10.8683 4.55532 11.346 3.19977 12.2349 2.14421C12.3949 1.95532 12.4371 1.68866 12.346 1.46643C12.2549 1.23865 12.046 1.09421 11.8016 1.07421C11.696 1.06643 11.5905 1.06643 11.4849 1.06643C8.75272 1.06643 6.26826 2.35532 4.69938 4.58866C3.1305 6.82199 2.77605 9.63865 3.74272 12.1331C4.70938 14.6275 6.84272 16.5887 9.43494 17.3609C10.2216 17.5998 11.046 17.7109 11.8683 17.7109C12.9594 17.7109 14.0349 17.4998 15.0527 17.0775C17.6449 16.0998 19.596 13.9387 20.2927 11.2665C20.3438 11.0775 20.2349 10.8775 20.046 10.7775C19.8738 10.6998 19.7016 10.5331 19.5016 11.4109Z"
              fill="currentColor"
              fillRule="evenodd"
            />
          </svg>
