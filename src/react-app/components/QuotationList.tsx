            ...
            <div className="quotation-list">
              {currentQuotations.map(quotation => (
                <div key={quotation.id} className="quotation-card">
                  <div className="client-name preview-client-detail">{clients[quotation.clientId]?.name || 'Loading...'}</div>
                  ...
                  <div className="client-email preview-client-detail">
                    <svg className="preview-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span>{clients[quotation.clientId]?.email || 'N/A'}</span>
                  </div>
